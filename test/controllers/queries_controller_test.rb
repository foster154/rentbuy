...
class QueriesControllerTest < ActionController::TestCase
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post :create, query: { area_id: @query.area_id, guest_id: @query.guest_id, payment: @query.payment }
    end
  ...
  test "should update query" do
    patch :update, id: @query, query: { area_id: @query.area_id, guest_id: @query.guest_id, payment: @query.payment }
    assert_redirected_to query_path(assigns(:query))
  end
